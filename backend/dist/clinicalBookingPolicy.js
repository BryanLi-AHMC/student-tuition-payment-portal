...
export function clinicalBookingPaymentDeadlineMsFromCreatedAt(createdAtMs) {
...
export function isClinicalBookingExpired(paymentDeadlineUtc, nowMs = Date.now()) {
    return paymentDeadlineUtc.getTime() <= nowMs;
}
//# sourceMappingURL=clinicalBookingPolicy.js.map