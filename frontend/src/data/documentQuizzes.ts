...
export type QuizId = 'ferpa' | 'titleix' | 'campus'
...
/** @deprecated Use QuizId — kept for submit/storage typings */
export type DocumentQuizId = QuizId

/** @deprecated Use Quiz */
export type DocumentQuizDefinition = Quiz

export type DocumentQuizQuestion = Quiz['questions'][number]

export const DOCUMENT_QUIZZES: Quiz[] = [
  {
    id: 'ferpa',
    title: 'FERPA',
    description: 'Complete FERPA policy training quiz',
    questions: [
      {
        id: 'ferpa-q1',
        question:
      ...
      {
        id: 'ferpa-q4',
        question: 'What information is public to anyone who asks?',
        options: [
      ...
      {
        id: 'ferpa-q5',
        question: 'What age are students considered "eligible students?"',
        options: ['13', '15', '21', '18'],
      },
    ],
    certificationText:
  ...
  },
  {
    id: 'titleix',
    title: 'Title IX',
    description: 'Complete Title IX policy training quiz',
    questions: [
      {
        id: 'titleix-q1',
        question: 'Which of the following options is part of sexual misconduct?',
        options: [
      ...
      {
        id: 'titleix-q3',
        question: 'Which of the following is NOT true about stalking?',
        options: [
      ...
      {
        id: 'titleix-q4',
        question: 'This is not an example of sexual harassment/misconduct:',
        options: [
          'Improper touch',
  ...
  },
  {
    id: 'campus',
    title: 'Campus Safety',
    description: 'Complete Campus Safety policy training quiz',
    questions: [
      {
        id: 'campus-q1',
        question:
...
export function getDocumentQuizById(id: QuizId): Quiz | undefined {
